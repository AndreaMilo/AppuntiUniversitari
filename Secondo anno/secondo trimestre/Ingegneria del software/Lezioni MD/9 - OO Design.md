...
```
## Operazioni
Sono mostrate in UML nel segmento inferiore e sono mostrate nel seguente modo:
...
### Molteplicità
>[!WARNING] Nota di Lanubile
>Lanubile preferisce la notazione con le frecce nelle associazioni di molteplicità e non i vari pallini
...
## Ruoli
Non è possibile definire dell'etichette alle associazioni ma possiamo definire dei **ruoli**.
